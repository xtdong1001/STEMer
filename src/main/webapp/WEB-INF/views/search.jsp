...
<div id="section1" class="container-fluid rounded position">
    <h5 style="padding-bottom: 30px;">POSITIONS</h5>
...
<div id="section2" class="container-fluid rounded position" style="margin-bottom: 70px">
    <h5 style="padding-bottom: 30px;">COMPANIES</h5>
    <div class="row" style="padding-bottom: 20px;">
...
<div id="section1" class="container-fluid rounded position">
    <h5 style="padding-bottom: 30px;">USERS</h5>
    <div class="row" style="padding-bottom: 20px;">
    	<c:forEach items="${requestScope.profiles}" var="profile">
    	<div class="col-lg-3 col-md-4 col-sm-6 col-12 mb-4">
                <div class="card rounded-top">
                    <img class="card-img-top rounded-circle center" src="/archive/${profile.portraitPath }" style="height: 100px; width: 100px; margin: auto; margin-top:30px;" alt="Card image">
                    <div class="card-body">
                        <div class="title-height">
                            <h6 class="card-title" style="line-height: 15px; text-align:center">${profile.firstName } ${profile.lastName }</h6>
                        </div>                        
                        <div class="companyName-height">
                            <p class="card-title" style="font-size: 14px; line-height: 15px; text-align:center">${profile.headline}</p>
                        </div>
                        <br>
                        <div>
                            <p class="card-text" style="color:gray; font-size: 12px; line-height: 15px; text-align:center">${profile.city}, ${profile.state}</p>
                        </div>
                    </div>
                    <div class="card-footer btn bg-dark ">
						<a href="${pageContext.request.contextPath}/profile/company/${profile.profileId}" class="card-link" style="color:white"><h6>View Profile</h6></a>
					</div>
				</div>
			</div>
        </c:forEach>
